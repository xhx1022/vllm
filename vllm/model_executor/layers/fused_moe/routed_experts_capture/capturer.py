...
class RoutedExpertsCapturer:
    ...
    def capture(self, layer_id: int, topk_ids: torch.Tensor) -> None:
        ...
        Args:
            ...
            topk_ids: Tensor of shape (num_tokens, num_experts_per_tok).
        """

        ctx = get_forward_context()
        if ctx.dp_metadata is None:  # single DP rank
            start_loc = 0
            end_loc = topk_ids.shape[0]
            token_num_per_dp = topk_ids.shape[0]
        else:  # multiple DP ranks
            ...
            if n == total:
                # topk_ids contains all DP ranks; slice this rank's rows.
                ...
                # topk_ids already contains only this DP rank.
                start_loc = 0
